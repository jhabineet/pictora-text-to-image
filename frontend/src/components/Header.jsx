...
const Header = () => {
  ...
  return (
    <motion.div className='flex flex-col items-center justify-center text-center my-20'
        ...
        animate={{ opacity: 1 }} transition={{ delay:0.4, duration: 2 }}>image</span>, in seconds.</motion.h1>
        ...
        className='flex flex-wrap justify-center gap-3 mt-16'>
            {Array(6).fill('').map((item, index) => (
                ...
                className='rounded hover:scale-105 transitioin-all duration-300 cursor-pointer max-sm:w-10'
        ...
        transition={{ delay: 1.2, duration: 0.8 }}
         className='mt-2 text-neutral-600'>Generated images from Pictora</motion.p>
    </motion.div>
  )
}
