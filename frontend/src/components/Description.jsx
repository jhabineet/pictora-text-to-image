...
const Description = () => {
  return (
    <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
        <h1 className='text-3xl sm:text-4xl font-semibold mb-2'>Create Beautiful AI Images</h1>
        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
            ...
            <div>
                ...
                <p className='text-gray-600'>Simply type in a text prompt, and our cutting edge Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla inventore minima veniam maxime voluptate perspiciatis totam quas aliquam quis reprehenderit. Tempore at similique nobis.</p>
            </div>
        </div>
    </div>
  )
